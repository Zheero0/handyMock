      ...
      <div className="grid grid-cols-1 relative sm:grid-cols-2 md:grid-cols-2  lg:grid-cols-2 gap-4 rounded-r-xl justify-center mx-auto">
        {currentJobs.map((job, index) => (
          <div
            ...
            className="flex rounded-xl cursor-pointer shadow-lg hover:shadow-md bg-transparent hover:shadow-blue-200 max-w-[700px] w-full  min-w-[550px] h-[150px] m-2 relative transition-transform duration-[1s] transform hover:scale-105"
          >
            {/* Image on the left */}
